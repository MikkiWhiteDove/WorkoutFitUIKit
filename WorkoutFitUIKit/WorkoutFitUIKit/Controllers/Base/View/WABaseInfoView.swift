...
extension WABaseInfoView {
    ...
    override func constraintViews() {
        ...
        let topContentAncor: NSLayoutAnchor = titleLabel.text == nil ? topAnchor : titleLabel.bottomAnchor
        let topContentOffset: CGFloat = titleLabel.text == nil ? 0 : 10
        ...
        NSLayoutConstraint.activate([
            ...
            contentView.topAnchor.constraint(equalTo: topContentAncor, constant: topContentOffset),
